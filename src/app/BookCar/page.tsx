            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-3 mx-3 md:mx-7">
                ...
                <div className="bg-white p-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 pt-2 gap-3">
                        <div>
                            ...
                            <input type="input" placeholder="Your Name" className="px-3 w-full py-2 rounded-xl bg-gray-200 text-[12px]" />
                        </div>
                        <div>
                            <h1 className="py-2 font-semibold">Phone Number</h1>
                            <input type="input" placeholder="Phone Number" className="px-3 w-full py-2 rounded-xl bg-gray-200 text-[12px]" />
                        </div>
                        <div>
                            <h1 className="py-2 font-semibold">Address</h1>
                            <input type="input" placeholder="Address" className="px-3 w-full py-2 rounded-xl bg-gray-200 text-[12px]" />
                        </div>
                        <div>
                ...
                <div className="bg-white p-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 pt-2 gap-3">
                        <div>
                            <h1 className="py-2 font-semibold">Locations</h1>
                            <div className="px-3 w-full py-2 rounded-xl bg-gray-200 text-[12px] flex justify-between items-center">
                ...
                <div className="bg-white p-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 p-3 mt-2 bg-gray-200 gap-3">
                        <div>
                            <h1 className="py-2 font-semibold">Card Number</h1>
                            <input type="input" placeholder="Card Number" className="px-3 w-full py-2 rounded-xl bg-white text-[12px]" />
                        </div>
                        <div>
                            <h1 className="py-2 font-semibold">Expiration Date</h1>
                            <input type="input" placeholder="DD/MM/YY" className="px-3 w-full py-2 rounded-xl bg-white-200 text-[12px]" />
                        </div>
                        <div>
                            <h1 className="py-2 font-semibold">Card Holder</h1>
                            <input type="input" placeholder="Card Holder" className="px-3 w-full py-2 rounded-xl bg-white-200 text-[12px]" />
                        </div>
                        <div>
