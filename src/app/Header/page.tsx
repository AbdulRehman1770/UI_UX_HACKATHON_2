...
=======
        <div className="relative mx-7">
          <input
            type="text"
            placeholder="Search Something Here"
            className="w-full md:w-96 border p-3 pl-10 bg-gray-200 rounded-lg outline-none"
          />
          <FaSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500" />
        </div>
      </div>
      ...
      <div className="bg-white order-2 md:order-none">
        <div className="flex justify-end md:justify-start md:gap-6 p-3">
          {/* Icons */}
          <img src="/Like.png" alt="Like" className="hidden md:block" />
          <img src="/Notification.png" alt="Notification" className="hidden md:block" />
          <img src="/Settings.png" alt="Settings" className="hidden md:block" />
          {/* Profile Image */}
          <img
            src="/Image.png"
            alt="Profile"
            className="relative w-8 md:w-auto md:ml-0"
          />
        </div>
      </div>
    </div>
