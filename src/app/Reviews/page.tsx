...
=======
                        <div className="bg-blue-500 mx-auto md:mx-0 col-span-3 md:w-[420px] w-80 h-[230px] rounded-2xl relative">
                            ...
                            <div className="absolute inset-5 w-80 font-bold text-white text-2xl">Sports Car With The Best Design and acceleration</div>
                            <div className="absolute top-24 left-5 text-[16px] text-white">safety and comfort while driving a futuristics and elegant sports car</div>
                            <div className="absolute md:top-40 md:left-28 top-40 left-16"><img src="/car1.png" alt="loading" /></div>

                        </div>
                        <div className="bg-blue-500 md:h-[105px] md:w-[125px] w-24 h-24 my-4 relative rounded-md">
                            <img src="/bg1.png" alt="Loading" />
                            <img src="/car1.png" alt="Loading" className="absolute top-6" />
                        </div>
                        <div className="bg-green-500 md:h-[105px] md:w-[125px] w-24 h-24 my-4 rounded-md">
                            <img src="/View2.png" alt="Loading" />
                        </div>
...
=======
                                <div className="relative md:left-[520px] left-[60px]">
                                    <p className="text-gray-500">21 July 2022</p>
...
<<<<<<< HEAD
                                <div className="relative md:left-[540px] left-24">
                                    ...
                                    <div className="flex gap-1">
=======
                                <div className="relative md:left-[540px] left-[75px]">
                                    <p className="text-gray-500">21 July 2022</p>
                                    <div className="flex gap-1 text-[12px] md:text-md">
>>>>>>> 341a056 (first commit)
=======
